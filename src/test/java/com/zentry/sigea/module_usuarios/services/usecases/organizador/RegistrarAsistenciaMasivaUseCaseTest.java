...
class RegistrarAsistenciaMasivaUseCaseTest {

    @Mock
    private IAsistenciaRepository asistenciaRepository;

    @InjectMocks
    private RegistrarAsistenciaMasivaUseCase registrarAsistenciaMasivaUseCase;
    ...
    void execute_registers_attendance_and_returns_message() {
        ...
        // Act
        String result =
            registrarAsistenciaMasivaUseCase.execute(dto);
