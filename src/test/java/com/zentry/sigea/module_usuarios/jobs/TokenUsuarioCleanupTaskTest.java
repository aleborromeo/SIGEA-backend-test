...
class TokenUsuarioCleanupTaskTest {

    @Mock
    private ITokenUsuarioRepository tokenUsuarioRepository;

    @InjectMocks
    private TokenUsuarioCleanupTask task;
    ...
    void limpiarTokensExpirados_invocaRepositorioConInstantActual() {
        ...
        verify(tokenUsuarioRepository, times(1))
                .deleteExpiredTokens(captor.capture());
